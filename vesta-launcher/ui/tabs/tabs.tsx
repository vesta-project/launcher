...
export function Tabs<T extends ValidComponent = "div">(
	...
	return <TabsPrimitive.Root class={clsx(styles["tabs"], local.class)} {...others} />;
}
...
export function TabsList<T extends ValidComponent = "div">(
	...
	return <TabsPrimitive.List class={clsx(styles["tabs__list"], local.class)} {...others} />;
}
...
export function TabsTrigger<T extends ValidComponent = "button">(
	...
	return <TabsPrimitive.Trigger class={clsx(styles["tabs__trigger"], local.class)} {...others} />;
}
...
export function TabsContent<T extends ValidComponent = "div">(
	...
	return <TabsPrimitive.Content class={clsx(styles["tabs__content"], local.class)} {...others} />;
}
...
export function TabsIndicator<T extends ValidComponent = "div">(
	...
	return (
		<TabsPrimitive.Indicator class={clsx(styles["tabs__indicator"], local.class)} {...others} />
	);
}
