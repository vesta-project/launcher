...
pub struct Instance {
    ...
    #[serde(default)]
    pub import_source_game_directory: Option<String>,
    #[serde(default)]
    pub import_launcher_kind: Option<String>,
    #[serde(default)]
    pub import_instance_path: Option<String>,
    ...
    pub use_global_launcher_action: bool,
    pub launcher_action_on_launch: Option<String>,
...
impl Default for Instance {
    fn default() -> Self {
        Instance {
            ...
            use_global_launcher_action: true,
            launcher_action_on_launch: None,
...
impl NewInstance {
    ...
    pub fn new(
        ...
        import_source_game_directory: Option<String>,
        import_launcher_kind: Option<String>,
        import_instance_path: Option<String>,
        ...
        launcher_action_on_launch: Option<String>,
        ...
        NewInstance {
            ...
            import_launcher_kind,
            import_instance_path,
