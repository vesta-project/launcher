    ...
    <div class={styles["settings-tab-content"]}>
        ...
        <SettingsField
          ...
          headerRight={
            <Switch
              ...
              onCheckedChange={props.handleTelemetryToggle}
            >
              <SwitchControl>
                <SwitchThumb />
              </SwitchControl>
      ...
      <SettingsCard header="System Tray">
        <SettingsField
          ...
          headerRight={
            <Switch
              ...
              onCheckedChange={props.handleAutostartToggle}
            >
              <SwitchControl>
                <SwitchThumb />
              </SwitchControl>
        ...
        <SettingsField
          ...
          headerRight={
            <Switch
              checked={props.showTrayIcon}
              onCheckedChange={props.handleShowTrayIconToggle}
            >
              <SwitchControl>
                <SwitchThumb />
              </SwitchControl>
        ...
        <SettingsField
          ...
          headerRight={
            <Switch
              ...
              onCheckedChange={props.handleCloseToTrayToggle}
            >
              <SwitchControl>
                <SwitchThumb />
              </SwitchControl>
