...
export function resolveResourceUrl(
  ...
  // Upgrade http:// to https:// (macOS ATS blocks insecure connections).
  // Use a regex anchored to the start to avoid replacing mid-URL occurrences.
  if (resolvedPath.startsWith("http://")) {
    return resolvedPath.replace(/^http:\/\//, "https://");
  }
