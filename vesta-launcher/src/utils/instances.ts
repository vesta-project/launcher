...
export interface Instance {
    ...
    installation_status?: 'pending' | 'installing' | 'installed' | 'failed' | null;
}
...
export async function killInstance(instance: Instance): Promise<void> {
    console.log("[killInstance] Invoking Tauri command to kill instance:", instance);
    try {
        await invoke("kill_instance", { instance });
        console.log("[killInstance] Kill command completed");
    } catch (e) {
