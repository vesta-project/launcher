...
## Core Components
- `vesta-launcher/src-tauri/` — Tauri host and Rust backend. Contains app configuration, Tauri commands, startup logic, and managers (e.g., `NotificationManager`, `TaskManager`).
