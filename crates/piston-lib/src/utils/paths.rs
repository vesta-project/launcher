...
/// Validate and normalize a relative path (mods, overrides, staging, repair, etc.).
...
mod tests {
    ...
    fn accepts_normal_nested_path() {
        let p = validate_relative_path("mods/foo.jar").unwrap();
    ...
    fn normalizes_backslashes() {
        let p = validate_relative_path("config\\test.properties").unwrap();
